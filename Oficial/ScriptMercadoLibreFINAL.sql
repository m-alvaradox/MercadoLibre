...
CREATE TABLE IF NOT EXISTS VISUALIZACION_PUBLICACIONES (
  ...
  CONSTRAINT fk_nopublicacion_vispub FOREIGN KEY (NOPUBLICACION) REFERENCES PUBLICACION (NOPUBLICACION)
);
...
CREATE TABLE IF NOT EXISTS PAGO (
  ...
  CONSTRAINT fk_idcliente_pago FOREIGN KEY (IDCLIENTE) REFERENCES CLIENTE (USERID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS PREGUNTA (
  ...
  CONSTRAINT fk_nopublicacion_pregunta FOREIGN KEY (NOPUBLICACION) REFERENCES PUBLICACION (NOPUBLICACION)
);
...
CREATE TABLE IF NOT EXISTS ORDEN (
  ...
  CONSTRAINT fk_idcliente_orden FOREIGN KEY (IDCLIENTE) REFERENCES CLIENTE (USERID) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT fk_idcupon_orden FOREIGN KEY (IDCUPON) REFERENCES CUPON (ID),
  ...
  CONSTRAINT fk_idvendedor_orden FOREIGN KEY (IDVENDEDOR) REFERENCES VENDEDOR (USERID) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT fk_iddreccion_orden FOREIGN KEY (IDDIRECCION) REFERENCES DIRECCION (ID),
  CONSTRAINT fk_idpublicacion_orden FOREIGN KEY (IDPUBLICACION) REFERENCES PUBLICACION (NOPUBLICACION)
);
...
CREATE TABLE IF NOT EXISTS RECLAMO (
  ...
  CONSTRAINT fk_vendedorid_reclamo FOREIGN KEY (VENDEDORID) REFERENCES VENDEDOR (USERID) ON DELETE CASCADE ON UPDATE CASCADE,
...
IDCLIENTE VARCHAR(50),
IDORDEN INT,
CONSTRAINT fk_idvendedor_factura FOREIGN KEY (IDVENDEDOR) REFERENCES VENDEDOR(USERID) ON DELETE CASCADE ON UPDATE CASCADE,
CONSTRAINT fk_idcliente_factura FOREIGN KEY (IDCLIENTE) REFERENCES CLIENTE(USERID) ON DELETE CASCADE ON UPDATE CASCADE,

...
CREATE TABLE IF NOT EXISTS PUBLICACION (
  ...
  FOREIGN KEY (IDVENDEDOR) REFERENCES VENDEDOR (USERID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
IDMENSAJE INT AUTO_INCREMENT,
  ...
  FOREIGN KEY (IDCLIENTE) REFERENCES CLIENTE (USERID) ON DELETE CASCADE ON UPDATE CASCADE,
   FOREIGN KEY (IDVENDEDOR) REFERENCES VENDEDOR (USERID) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS CUPON (
  ...
  VECES INT NOT NULL,
  FOREIGN KEY (CLIENTEID) REFERENCES CLIENTE (USERID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS RECLAMO (
  ...
  ORDERID INT,
  FOREIGN KEY (CLIENTEID) REFERENCES CLIENTE (USERID) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (VENDEDORID) REFERENCES VENDEDOR (USERID) ON DELETE CASCADE ON UPDATE CASCADE,
...
(7002,'naybor','ownyag',5,'FALLO ENTREGA', 'Abierto');

INSERT INTO FACTURA VALUES
(8989,'2023-12-14','COMPRA DE PRODUCTOS','ownyag','malvaradox',1);
